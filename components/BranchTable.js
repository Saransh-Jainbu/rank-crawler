export default function BranchTable({ branch, rows }) {
  ...
  return (
    <div className="card overflow-hidden mb-8 animate-slide-in">
      {/* Header */}
      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-4 md:px-6 py-4 md:py-5">
        ...
        <table className="w-full">
          ...
          <tbody>
            {sortedRows.map((row, idx) => (
              ...
              >
                <td className="px-6 py-4 font-bold text-purple-600 text-lg">Round {row.Round}</td>
        ...
        {sortedRows.map((row, idx) => (
          ...
          >
            <div className="flex items-center justify-between mb-3 pb-3 border-b border-gray-300">
              <span className="font-bold text-purple-600 text-lg">Round {row.Round}</span>
